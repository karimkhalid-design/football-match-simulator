...
type View = "categories" | "group" | "solo" | "road" | "library" | "auction" | "aftakar" | "var" | "menbyehbad";

function App() {
  const [view, setView] = useState<View>(() => window.location.hash === "#categories" ? "categories" : window.location.hash === "#aftakar" ? "aftakar" : window.location.hash === "#var" ? "var" : window.location.hash === "#menbyehbad" ? "menbyehbad" : window.location.hash === "#auction" ? "auction" : window.location.hash === "#solo" ? "solo" : window.location.hash === "#road" ? "road" : window.location.hash === "#library" ? "library" : "group");
