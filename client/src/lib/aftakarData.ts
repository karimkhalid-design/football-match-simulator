...
const realisticOptionGroups: Record<RealisticOptionGroup, string[]> = {
  ...
  "ballon-dor-1990s": ["Zinedine Zidane", "Ronaldo Nazário", "Luis Figo", "Ronaldinho"],
  "ballon-dor-2000s": ["Kaká", "Ronaldinho", "Ronaldo Nazário", "Cristiano Ronaldo", "Lionel Messi", "Luis Figo"],
  "ballon-dor-2010s": ["Luka Modrić", "Cristiano Ronaldo", "Lionel Messi", "Mohamed Salah", "Karim Benzema", "Robert Lewandowski"],
...
const factualQuestions: AftakarQuestion[] = [
  ...
  { playerName: "Zinedine Zidane", clues: ["من فاز بالكرة الذهبية عام 1998 وهو يلعب مع يوفنتوس؟", "جاءت الجائزة في عام فاز فيه أيضاً بكأس العالم مع منتخب بلاده", "الاختيارات صانعو لعب ومهاجمون فازوا بالجائزة في فترات قريبة"], options: ["Zinedine Zidane", "Ronaldo Nazário", "Luis Figo", "Ronaldinho"], category: "award", optionGroup: "ballon-dor-1990s" },
  { playerName: "Kaká", clues: ["من فاز بالكرة الذهبية عام 2007 وهو لاعب في ميلان؟", "سبق الجائزة تتويج فريقه بدوري أبطال أوروبا في العام نفسه", "الاختيارات تضم صانعي لعب فازوا أو نافسوا على الجائزة في فترات قريبة"], options: ["Kaká", "Ronaldinho", "Ronaldo Nazário", "Cristiano Ronaldo"], category: "award", optionGroup: "ballon-dor-2000s" },
  { playerName: "Luka Modrić", clues: ["من فاز بالكرة الذهبية عام 2018 وهو يلعب مع ريال مدريد؟", "وصل في العام نفسه إلى نهائي كأس العالم مع منتخب بلاده", "الاختيارات لاعبو وسط من جيل الجوائز نفسه"], options: ["Luka Modrić", "Cristiano Ronaldo", "Lionel Messi", "Mohamed Salah"], category: "award", optionGroup: "ballon-dor-2010s" },
  { playerName: "Lionel Messi", clues: ["من فاز بالكرة الذهبية عام 2019 وهو لاعب في برشلونة؟", "كان ينافسه في القائمة لاعبون من ليفربول ويوفنتوس", "السؤال عن الجائزة في ذلك العام وليس عن عدد مرات الفوز الكلي"], options: ["Lionel Messi", "Cristiano Ronaldo", "Luka Modrić", "Karim Benzema"], category: "award", optionGroup: "ballon-dor-2010s" },
  { playerName: "Karim Benzema", clues: ["من فاز بالكرة الذهبية عام 2022 وهو لاعب في ريال مدريد؟", "جاءت الجائزة بعد موسم تهديفي حاسم في دوري أبطال أوروبا", "الاختيارات مهاجمون من أندية أوروبية كبيرة"], options: ["Karim Benzema", "Lionel Messi", "Cristiano Ronaldo", "Robert Lewandowski"], category: "award", optionGroup: "ballon-dor-2010s" },
