...
const bundesligaNames = new Set(["Manuel Neuer", "Oliver Kahn", "Sepp Maier", "Bernd Leno", "Jürgen Kohler", "Matthias Sammer", "Mats Hummels", "Niklas Süle", "Matthias Ginter", "Antonio Rüdiger", "Benjamin Pavard", "Noussair Mazraoui", "Philipp Lahm", "Berti Vogts", "Paul Breitner", "Bixente Lizarazu", "Raphaël Guerreiro", "Lothar Matthäus", "Günter Netzer", "Michael Ballack", "Bastian Schweinsteiger", "Sami Khedira", "Toni Kroos", "Leon Goretzka", "Thomas Müller", "Mario Götze", "Jamal Musiala", "Marco Reus", "Serge Gnabry", "Leroy Sané", "Kingsley Coman", "Arjen Robben", "Franck Ribéry", "Robert Lewandowski", "Gerd Müller", "Miroslav Klose", "Erling Haaland", "Harry Kane", "Mario Mandžukić"]);
const egyptianLeagueNames = new Set(["Essam El Hadary", "Ahmed El Shenawy", "Mohamed El Shenawy", "Ahmed Hegazi", "Ramy Rabia", "Ali Gabr", "Mahmoud Hamdy El Wensh", "Ayman Ashraf", "Mohamed Hany", "Omar Kamal", "Ahmed Fathi", "Sacha Boey", "Ahmed Abu El Fotouh", "Ali Maaloul", "Karim Hafez", "Mohamed Hamdy", "Mohamed Elneny", "Amr El Solia", "Tarek Hamed", "Hamdy Fathy", "Mohamed Aboutrika", "Emam Ashour", "Hossam Ashour", "Mostafa Mohamed", "Abdallah El Said", "Shikabala", "Walid Soliman", "Amr Warda", "Ahmed Hassan", "Trézéguet", "Mahmoud Kahraba", "Hussein El Shahat", "Omar Marmoush", "Ibrahim Adel", "Ahmed Refaat", "Mostafa Fathi", "Ahmed Hassan Kouka", "Hossam Hassan", "Mido", "Amr Zaki"]);
