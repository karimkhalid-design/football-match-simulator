...
const egyptianLeagueNames = new Set(["Essam El Hadary", "Nader El-Sayed", "Ahmed Nagy", "Mostafa Shobeir", "Hamza Alaa", "Ahmed El Shenawy", "Mohamed El Shenawy", "Ahmed Hegazi", "Mohamed Abdelmonem", "Yasser Ibrahim", "Mahmoud Alaa", "Ramy Rabia", "Ali Gabr", "Mahmoud Hamdy El Wensh", "Ayman Ashraf", "Mohamed Hany", "Omar Kamal", "Ahmed Elmohamady", "Hazem Emam", "Ahmed Fathi", "Sacha Boey", "Ahmed Abu El Fotouh", "Mohamed Abdel Shafy", "Sayed Moawad", "Ali Maaloul", "Karim Hafez", "Mohamed Hamdy", "Mohamed Elneny", "Amr El Solia", "Tarek Hamed", "Hamdy Fathy", "Mohamed Aboutrika", "Mohamed Magdy Afsha", "Marwan Attia", "Aliou Dieng", "Hossam Ghaly", "Mohamed Shawky", "Emam Ashour", "Hossam Ashour", "Mostafa Mohamed", "Mohamed Zidan", "Mohamed Barakat", "Abdallah El Said", "Shikabala", "Walid Soliman", "Amr Warda", "Ahmed Hassan", "Trézéguet", "Mahmoud Kahraba", "Hussein El Shahat", "Omar Marmoush", "Ibrahim Adel", "Ahmed Refaat", "Mostafa Fathi", "Ahmed Sayed Zizo", "Mohamed Sherif", "Ahmed Hassan Kouka", "Ahmed Yasser Rayan", "Marwan Hamdy", "Emad Moteab", "Abdel Halim Ali", "Gamal Hamza", "Mahmoud El Khatib", "Hossam Hassan", "Mido", "Amr Zaki"]);
