  ...
  return <main className="auction-app" dir="rtl">
    ...
    <section className="auction-layout">
      ...
      <article className="auction-stage">
        ...
        <div className="bid-step-control"><div><span>السعر الإجمالي للاعب</span><small>اكتب المبلغ النهائي مثل 20M</small></div><label><input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="السعر" aria-label="السعر الإجمالي للاعب بالمليون" value={bidAmountText} onChange={(event) => setBidAmountText(event.target.value.replace(/[^0-9]/g, ""))} /><b>M</b></label><div className="bid-step-presets"><button type="button" onClick={() => setBidAmountText("10")}>10M</button><button type="button" onClick={() => setBidAmountText("20")}>20M</button><button type="button" onClick={() => setBidAmountText("30")}>30M</button></div></div>
