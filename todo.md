...
- [x] إضافة تسجيل دخول ولوج إن خاص بقسم الأونلاين فقط
- [x] دعم تسجيل سريع عبر Google وApple باستخدام مزود المصادقة المتاح
- [x] ربط الاسم والملف المختصر بحساب اللاعب بدلاً من إدخاله كل مرة
- [x] إضافة دعوة أصدقاء ورابط غرفة قابل للمشاركة والعودة للعب معاً
- [x] الحفاظ على دخول باقي الألعاب بدون حساب واختبار تدفق الحساب والدعوة ثم حفظ checkpoint

- [x] تحديث حالة الحساب تلقائياً بعد الرجوع من OAuth وإظهار «تم تسجيل الدخول» داخل الأونلاين
- [x] تصميم شاشة تسجيل خاصة بهوية «كورة كده» مع أزرار Google وApple واضحة
- [x] إظهار اسم الحساب المحفوظ داخل صفحة الأونلاين بعد التسجيل
- [x] اختبار العودة من التسجيل وتدفق دعوة الغرفة ثم حفظ checkpoint

- [x] إضافة Username ثابت يختاره اللاعب بعد التسجيل
- [x] حفظ الاسم والتحقق من التفرد وصحة الصيغة
- [x] استخدام Username في غرف الأونلاين والمتصدرين ودعوات الأصدقاء
- [x] إضافة اختبارات الاسم والتسجيل والتدفق ثم حفظ checkpoint

- [x] تشخيص سبب عدم اكتمال تسجيل الدخول أو حفظ Username في الأونلاين
- [x] إصلاح رسالة الخطأ وتدفق العودة من OAuth أو حفظ الاسم
- [x] اختبار التسجيل الناجح والفاشل ودخول الغرفة ثم حفظ checkpoint
