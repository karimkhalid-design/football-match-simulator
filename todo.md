...
- [x] جعل ترتيب لاعبي المزاد عشوائيًا ومختلفًا في كل جلسة حسب القسم المختار
- [x] إضافة اختبار يثبت اختلاف الترتيب ومنع تكرار اللاعبين ثم التحقق البصري وحفظ checkpoint على Manus

- [x] إزالة التلميحات بالكامل من لعبة «الطريق ما يتوهش» وواجهة التلميحات المرتبطة بها
- [x] رفع صعوبة أسئلة تخمين اللاعب درجة واحدة مع الحفاظ على بيانات كروية واقعية
- [x] إضافة اختبارات للتلميحات والصعوبة والتحقق البصري وحفظ checkpoint على Manus
